...
import com.example.jayraj.pridictive__model.Adapter.PredictionAdapter;
import com.example.jayraj.pridictive__model.R;

import java.util.ArrayList;

public class Bpi_Prediction extends PridictiveFragment {
  ...
  //  ActionBar actionBar;
    ...
    //    actionBar = getActivity().getActionBar();
     //   actionBar.setTitle("BPI Prediction");
